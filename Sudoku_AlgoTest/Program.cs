...
namespace Sudoku_AlgoTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(_SudokuValidate1.StartValidation());
            Console.WriteLine(_SudokuValidate2.StartValidation());
            Console.WriteLine(_SudokuValidate3.StartValidation());
            Console.WriteLine(_SudokuValidate4.StartValidation());
        }
    }
    ...
    public class SudokuValidation
    {
        ...
        {
            for (var row = 0; row < _SudokoGrid.Length; row++)
            {
                var usedNumbers = new bool[10];
                for (var column = 0; column < _SudokoGrid.Length; column++)
                {
                    var number = _getNumber(row, column);
